...
import io.github.shardkiht.rentdetective.semantic.entity.ScamRule;
...
public class ScamRuleRegistry {
    ...
    public void init() {
        try {
            ...
            try (InputStream is = resource.getInputStream()) {
                List<ScamRule> rules = mapper.readValue(is, new TypeReference<List<ScamRule>>() {});
    ...
    /** 按 ruleType 获取规则 */
    public Optional<ScamRule> getRule(String ruleType) {
